        ...
        if (
          ...
          if (this.state.valueid[0] == "4") {
            ...
            if (this.state.numChildren === 0) {
              console.log(this.state.numChildren.value);
              confirmAlert({
                title: "Alert !",
              ...
              console.log(`OptsValues: `, this.state.numChildren);
              let otval = [];
              for (var i = 0; i < this.state.numChildren; i++) {
                console.log(`OptsValues: ffff`, i);
                if (
  ...
  FetchQuestionsByTask(e) {
    ...
    if (this.props.location.state) {
      ...
      fetch("/GetQtypesByFormat", {
        ...
        .then(response => {
          var DecryptedResponse = decryptData(response);
          console.log(`karan1`, DecryptedResponse);
          if (DecryptedResponse.errorCode === "00") {
            ...
            console.log(
              "response: Question Formats:" + this.props.location.state.role_id
            );
          }
        })
        .catch(error => {
      ...
      console.log("req taskid", EncryptedRequest4);
